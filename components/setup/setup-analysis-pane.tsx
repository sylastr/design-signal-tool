...
import { clearAllData, MAX_SUGGESTIONS, MIN_SUGGESTIONS } from "@/lib/storage"
...
export function SetupAnalysisPane({
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* Reset — wipes all stored data and restores defaults. */}
      <section aria-labelledby="analysis-reset" className="flex flex-col gap-3">
        <div>
          <h4
            id="analysis-reset"
            className="text-[11px] font-semibold uppercase tracking-[0.14em] text-gray-4"
          ...
          <p className="mt-1 text-sm text-gray-4">
            Restore all settings to their defaults and remove every saved skill, context, and
